...
namespace ContosoUniversity1.Controllers
{
    public class StagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StageID,titre,description,debut,fin,etat")] Stage stage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StageID,titre,description,debut,fin,etat")] Stage stage)
        {
            if (id != stage.StageID)
            {
                return NotFound();
